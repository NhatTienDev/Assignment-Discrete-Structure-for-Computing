...
df = pd.read_csv('D:\Assignment Discrete Structure for Computing\DIG Historical Data.csv', index_col = 'Date', parse_dates = True)
df = df.dropna()
...
plt.title('Price for the next 3 months of stock index DIG')
plt.xlabel('Index')
