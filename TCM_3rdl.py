...
df = pd.read_csv('D:\Assignment Discrete Structure for Computing\TCM Historical Data.csv', index_col = 'Date', parse_dates = True)
df = df.dropna()
...
plt.title('Price for the next 3 months of stock index TCM')
plt.xlabel('Index')
