...
df = pd.read_csv('D:\Assignment Discrete Structure for Computing\ZHH Historical Data.csv', index_col = 'Date', parse_dates = True)
df = df.dropna()
...
plt.title('Price for the next 3 months of stock index NHH')
plt.xlabel('Index')
